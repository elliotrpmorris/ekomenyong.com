...
<Image
  ...
  priority
/>
<p className="text-xs italic text-center">The modern WordPress tools and plugins I was using in 2018. </p>
...
<Image
  ...
  priority
/>
<p className="text-xs italic text-center">A screenshot of Sanity Studio</p>
